...
#include "daxa/daxa.hpp" // IWYU pragma: export
...
class Camera {
public:
  Camera(Window *window, glm::vec3 camPosition = glm::vec3(0.F, 0.F, 2.0F),
         glm::vec3 wrdUp = glm::vec3(0.F, 1.F, 0.F), float camYaw = 0, float camPitch = 0,
         float vFov = 60.F)
